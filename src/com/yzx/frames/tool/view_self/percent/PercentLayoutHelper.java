...
package com.yzx.frames.tool.view_self.percent;
 ...
 * 
 * <p>
 * This class collects utility methods that are involved in extracting percentage based dimension attributes and applying them to
 * ViewGroup's children. If you would like to implement a layout that supports percentage based dimensions, you need to take several steps:
 * 
 * <ol>
 ...
 * <li>In your {@code LayoutParams(Context c, AttributeSet attrs)} constructor create an instance of
 * {@link PercentLayoutHelper.PercentLayoutInfo} by calling {@link PercentLayoutHelper#getPercentLayoutInfo(Context, AttributeSet)}. Return
 * this object from {@code public PercentLayoutHelper.PercentLayoutInfo getPercentLayoutInfo()} method that you implemented for
 * {@link android.support.percent.PercentLayoutHelper.PercentLayoutParams} interface.
 * <li>Override {@link ViewGroup.LayoutParams#setBaseAttributes(TypedArray, int, int)} with a single line implementation
 * {@code PercentLayoutHelper.fetchWidthAndHeight(this, a, widthAttr, heightAttr);}
...
public class PercentLayoutHelper {
	...
	/**
	 * Helper method to be called from {@link ViewGroup.LayoutParams#setBaseAttributes} override that reads layout_width and layout_height
	 * attribute values without throwing an exception if they aren't present.
	 */
	...
	/**
	 * Iterates over children and restores their original dimensions that were changed for percentage values. Calling this method only makes
	 * sense if you previously called {@link PercentLayoutHelper#adjustChildren(int, int)}.
	 */
	...
	public static class PercentLayoutInfo {
		...
		public String toString() {
			return String.format("PercentLayoutInformation width: %f height %f, margins (%f, %f, " + " %f, %f, %f, %f)", widthPercent,
					heightPercent, leftMarginPercent, topMarginPercent, rightMarginPercent, bottomMarginPercent, startMarginPercent,
					endMarginPercent);
		}
